{{-- Archivo: resources/views/productos-venta/create.blade.php --}}
@extends('template')

@section('title', 'Agregar Producto de Venta')
...
<div class="container-fluid px-4">
    <h1 class="mt-4 text-center">Agregar Producto de Venta Manual</h1>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('productos-venta.store') }}" method="POST" id="productoForm">
                @csrf
                <div class="row mb-3">
                    <div class="col-md-6">
