                ...
                <div class="info-card">
                    ...
                    <div class="user-info">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                @if ($reserva->user)
                                    <span class="text-light">{{ $reserva->user->name }}</span>
                                @else
                    ...
                    @if ($reserva->alquiler)
                        <div class="mb-2">
                            ...
                            <span>Alquiler ID#{{ $reserva->alquiler->id }}</span>
                        </div>
                    @endif
                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 text-center">
                                ...
                                <div
                                    class="badge {{ $reserva->fecha_entrega_programada <= now() && $reserva->estado === 'confirmada' ? 'bg-danger' : 'bg-secondary' }} fs-6 p-2">
                            ...
                            <div class="col-md-4 text-center">
                                ...
                                <div class="badge bg-primary fs-6 p-2">
                                    {{ $reserva->fecha_devolucion_programada->format('d/m/Y') }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="detail-card">
                                    ...
                                    <p><strong>Seña Pagada:</strong> ₲
                                        {{ number_format($reserva->seña_alquiler, 0, ',', '.') }}</p>
                                    <p><strong>Saldo:</strong> <span class="amount-display text-primary">₲
                                            {{ number_format($reserva->saldo_alquiler, 0, ',', '.') }}</span></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="detail-card">
                                    ...
                                    <p><strong>Saldo:</strong> <span class="amount-display text-success">₲
                                            {{ number_format($reserva->saldo_garantia, 0, ',', '.') }}</span></p>
                                </div>
                            </div>
                        </div>
                        ...
                        @if ($reserva->estado === 'confirmada')
                            <div class="alert alert-info text-center">
                                <h5 class="mb-0">
                                    <strong>TOTAL A COBRAR EN ENTREGA: ₲
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="alert alert-info">
                            ...
                            <p><strong>TOTAL A COBRAR HOY: ₲
                                    {{ number_format($reserva->total_a_cobrar, 0, ',', '.') }}</strong></p>
                        </div>
